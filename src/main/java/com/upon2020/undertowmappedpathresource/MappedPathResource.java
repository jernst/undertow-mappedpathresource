 ...
 *
 */
public class MappedPathResource implements RangeAwareResource {
    private final Path file;
    private final String path;
    private final ETag eTag;
    private final MappedPathResourceManager manager;

    public MappedPathResource(final Path file, final MappedPathResourceManager manager, String path, ETag eTag) {
        this.file = file;
        this.path = path;
    ...
    public MappedPathResource(final Path file, final MappedPathResourceManager manager, String path) {
